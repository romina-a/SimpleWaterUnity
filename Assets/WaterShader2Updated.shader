Shader "WaterShader2Updated"
{
    Properties
    {
		...
		_WaterNormalX ("Water Normal X", float) = 0.0
		_WaterNormalY ("Water Normal Y", float) = 1.0
		_WaterNormalZ ("Water Normal Z", float) = 0.0
    ...
    SubShader
    {
		...
		************************************/
        ...
        Pass
        {
		 ...
		 float  _WaterNormalX, _WaterNormalY, _WaterNormalZ;
         float4 _TopColor, _Color;
         ...
         v2f vert (appdata v)
         {
			...
			float3 _WaterNormal = float3(_WaterNormalX, _WaterNormalY, _WaterNormalZ);
			float3 wn = normalize (_WaterNormal);
